    ...
    @if ($hasCompteInvestisseur)
        <div class="container flex flex-col-reverse xl:flex-row mx-auto">
            <div class="space-y-5 w-full px-2">
                ...
                <div class="flex space-y-3 flex-col lg:flex-row justify-between py-2 px-4 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out">
    <div class="flex justify-between lg:justify-center items-start lg:items-center space-x-3">
    <div class="flex space-x-3"><img class="rounded-full bg-cover bg-center h-[50px] w-auto transition-transform duration-300 ease-in-out transform hover:scale-105"
            src="{{ $offre->compteStartup->url_logo }}" alt="">
        <div class="flex space-x-3">
            <div>
                <h2 class="flex text-[#0D062D] font-semibold text-[18px] mb-2 md:mb-0 transition-colors duration-300 ease-in-out hover:text-[#8D6CFF]">
        ...
        <div class="items-center flex lg:hidden space-x-5">
            <div class="text-base font-semibold">
                <x-heroicon-s-star class="w-6 h-6 text-yellow-400 transition-transform duration-300 ease-in-out transform hover:scale-110" />
            </div>
            <a href="{{ route('offre.show', $offre->id) }}" class="flex md:justify-center text-[18px] md:text-center text-black hover:text-[#8D6CFF] transition-colors duration-300">
