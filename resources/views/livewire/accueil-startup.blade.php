<div class="">
    ...
    @if ($hasCompteStartup)
        ...
        <div class="container flex flex-col-reverse xl:flex-row mx-auto gap-10">
            ...
            <div class="w-full flex flex-col space-y-5 px-2 bg-[#F5F5F5] rounded-t-2xl">
                ...
                @forelse ($mesOffres as $offre)
                        <div
                            ...
                            <div class="flex flex-row items-center py-2 justify-between gap-4 sm:flex-col sm:items-end sm:w-1/2">
                                <!-- Statut -->
            ...
            <div class="w-full  xl:max-w-[400px] bg-[#F5F5F5] rounded-2xl ">
                <div class="flex bg-[#F5F5F5] rounded-2xl flex-col container mx-auto">
                    <header>
                ...
                <div
                    class="w-full overflow-x-auto flex gap-5 xl:px-2 xl:py-5 md:border-none flex-row lg:flex-col py-5 sm:p-5 border-b-4 mb-10 xl:mb-0 xl:mx-0 border-[#8BC48A]">
