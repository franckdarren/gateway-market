<div x-data="{ type: '', mode: '' }" class="max-w-2xl mx-auto px-8 pb-8 bg-white rounded-lg shadow-lg">
    <!-- Message de succès -->
    @if (session('success'))
        <div class="flex items-center justify-between p-4 mx-auto mb-4 space-x-4 text-white bg-green-500 rounded-md shadow-md md:fixed md:top-5 md:right-5"
            ...
            <button class="text-white hover:text-gray-200 focus:outline-none" @click="open = false" wire:click='$refresh'>
    ...
    <div>
        ...
        <form wire:submit.prevent="submit" class="space-y-6">
            ...
            <div>
                ...
                <select x-model="type" id="type" wire:model="type"
            ...
            <!-- Mode de Retrait -->
            <div x-show="type === 'retrait'" class="mt-4">
            ...
            <!-- Mode de Dépot -->
            <div x-show="type === 'depot'" class="mt-4">
                ...
                <select wire:model="mode_depot" id="mode_depot"
                    class="block w-full px-4 py-2 mt-1 border bg-gray-100 border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                    <option value="">Choisir un mode de dépot</option>
                    <option value="AirtelMoney">AirtelMoney</option>
                    <option value="MoovMoney">MoovMoney</option>
                    <option value="Virement">Virement</option>
                </select>
            ...
            <div x-show="type === 'depot'" class="mt-4">
                <label for="numero_transaction" class="block text-sm font-medium text-gray-700">Numéro de la
                    transaction</label>
