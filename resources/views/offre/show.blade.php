                ...
                <table class="table-auto w-full border-collapse border border-gray-300 text-left">
                    <thead>
                        <tr class="bg-gray-200">
                            <th class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-semibold text-gray-700">Mois de remboursement</th>
                            <th class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-semibold text-gray-700">Mois de grâce</th>
                            <th class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-semibold text-gray-700">Taux d'intérêt</th>
                            <th class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-semibold text-gray-700">VAN</th>
                            <th class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-semibold text-gray-700">IR</th>
                            <th class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-semibold text-gray-700">TRI</th>
                            <th class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-semibold text-gray-700">KRL</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="bg-white">
                            <td class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-bold">{{ $offre->nbre_mois_remboursement }} mois</td>
                            <td class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-bold">{{ $offre->nbre_mois_grace }} mois</td>
                            <td class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-bold">{{ $offre->taux_interet }}%</td>
                            <td class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-bold">{{ number_format($offre->van, 2, ',', ' ') }} FCFA</td>
                            <td class="border border-gray-300 px-2 py-2 sm:px-4 text-sm">{{ $offre->ir }}</td>
                            <td class="border border-gray-300 px-2 py-2 sm:px-4 text-sm">{{ $offre->tri }}</td>
                            <td class="border border-gray-300 px-2 py-2 sm:px-4 text-sm">{{ $offre->krl }}</td>
                        </tr>
                    </tbody>
                </table>
                </div>
                <table class="table-auto block lg:hidden w-full border-collapse border border-gray-300 text-left">
                    <thead>
                        <tr class="bg-gray-200">
                            <th class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-semibold text-gray-700">Mois de remboursement</th>
                            <th class="border border-gray-300 px-2 py-2 sm:px-4 text-sm font-semibold text-gray-700">Mois de grâce</th>
